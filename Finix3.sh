...
class LocationController extends Controller
{
    ...
    public function index(): View
    {
        ...
        $user = Auth::user();
        if (!$user || $user->id !== 1) {
            abort(403, 'LightSecret Protect ©𝗣𝗿𝗼𝘁𝗲𝗰𝘁 𝗕𝗬 𝗙𝗜𝗡𝗜𝗫-𝗖𝗬𝗕𝗘𝗥 t.me/LingCode1. - Akses ditolak ❌');
        }
    ...
    public function view(int $id): View
    {
        ...
        $user = Auth::user();
        if (!$user || $user->id !== 1) {
            abort(403, 'LightSecret ©𝗣𝗿𝗼𝘁𝗲𝗰𝘁 𝗕𝗬 𝗙𝗜𝗡𝗜𝗫-𝗖𝗬𝗕𝗘𝗥 t.me/LingCode1. - Akses ditolak ❌');
        }
